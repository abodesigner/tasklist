                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex justify-center items-center space-x-2">
                        ...
                        <input
                            ...
                            className="h-4 w-4 rounded border-gray-100 text-indigo-600 focus:ring-indigo-600"
                        />

                        <p className={`text-gray-300 ${task.isDone ? "line-through" : null}`}>{task.text.trim().toLowerCase()}</p>
